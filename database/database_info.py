...
DBINDEX_SAVED_CHARACTER_EQUIPMENT_ID = 6
DBINDEX_SAVED_CHARACTER_INVENTORY_ID = 7
...
DBINDEX_SC_EQUIPMENT_NECKLACE_ID = 3
DBINDEX_SC_EQUIPMENT_CHESTGUARD_ID = 4
DBINDEX_SC_EQUIPMENT_BRACER_ID  = 5
DBINDEX_SC_EQUIPMENT_GLOVES_ID = 6
DBINDEX_SC_EQUIPMENT_BELT_ID = 7
DBINDEX_SC_EQUIPMENT_LEGGINGS_ID = 8
...
# creature_defaults table
DBINDEX_CREATURE_DEFAULTS_CREATURE_LEVEL = 0
DBINDEX_CREATURE_DEFAULTS_ARMOR = 1
DBINDEX_CREATURE_DEFAULTS_MIN_GOLD_REWARD = 2
DBINDEX_CREATURE_DEFAULTS_MAX_GOLD_REWARD = 3
DBINDEX_CREATURE_DEFAULTS_XP_REWARD = 4
...
# item_template table
# TODO: Change the way we store stats on an item, where we have certain stat slots that point to an ID of a stat
# TODO: That way it is scalable and having 50 stats won't be a problem.
DBINDEX_ITEM_TEMPLATE_ENTRY = 0
DBINDEX_ITEM_TEMPLATE_NAME = 1
DBINDEX_ITEM_TEMPLATE_TYPE = 2
DBINDEX_ITEM_TEMPLATE_SUB_TYPE = 3
DBINDEX_ITEM_TEMPLATE_ARMOR = 4
DBINDEX_ITEM_TEMPLATE_HEALTH = 5
DBINDEX_ITEM_TEMPLATE_MANA = 6
DBINDEX_ITEM_TEMPLATE_STRENGTH = 7
DBINDEX_ITEM_TEMPLATE_AGILITY = 8
DBINDEX_ITEM_TEMPLATE_BUY_PRICE = 9
DBINDEX_ITEM_TEMPLATE_SELL_PRICE = 10
DBINDEX_ITEM_TEMPLATE_MIN_DMG = 11
DBINDEX_ITEM_TEMPLATE_MAX_DMG = 12
DBINDEX_ITEM_TEMPLATE_QUEST_ID = 13
DBINDEX_ITEM_TEMPLATE_EFFECT = 14
