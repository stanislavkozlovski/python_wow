...
Intentionally not using pygame, the goal of this project is to see how far I can go without the use of too many third-party modules. (an exception is termcolor, which lets me print in color.)
